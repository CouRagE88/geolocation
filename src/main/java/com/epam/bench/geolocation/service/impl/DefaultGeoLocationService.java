...
public class DefaultGeoLocationService implements GeoLocationService {
    private static final Logger logger = LoggerFactory.getLogger(DefaultGeoLocationService.class);

    @Autowired
    private GeoLocationDao geoLocationDao;

    public GeoLocation getGeoLocation(String ipAddress) throws GenericException {
        ...
        GeoLocation geoLocation = geoLocationDao.getGeoLocation(ipNumber);
     ...
     */
    private void validateLocation(GeoLocation geoLocation) throws LocationDoesNotExistException {
